 ...
 const APPAREL_SIM = {"m_tshirt": ["Sand", "Heather Grey", "Light Blue", "Black", "Charcoal", "Navy", "Red", "Maroon", "Purple"], "w_tshirt": ["Light Blue", "Black", "Charcoal", "Navy", "Red", "Purple"], "m_tank": ["Black", "Navy", "Red"], "m_longsleeve": ["Sand", "Light Blue", "Black", "Navy", "Red", "Maroon", "Forest Green", "Purple"], "m_hoodie": ["Sand", "Heather Grey", "Light Blue", "Black", "Navy", "Red", "Maroon", "Forest Green", "Purple"], "w_hoodie": ["Light Blue", "Black", "Charcoal", "Navy", "Red", "Purple"], "m_sweatshirt": ["Sand", "Heather Grey", "Light Blue", "Black", "Navy", "Red", "Maroon", "Forest Green", "Purple"]};
