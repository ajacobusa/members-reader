 ...
 *{{box-sizing:border-box}}
 ...
 .qjwrap{{max-width:640px;margin:0 auto 16px;border:1px solid var(--line);
   border-radius:14px;background:#fff;padding:4px 10px}}
 .qjwrap>summary.qjsum{{cursor:pointer;list-style:none;text-align:center;
   padding:9px;color:var(--green);font-weight:700;font-size:15px}}
...
<div id="site" style="{site_style}">
 ...
 <details class="qjwrap"><summary class="qjsum">Jump to a design <small>tap to pick from all designs</small></summary>
