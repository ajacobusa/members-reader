 ...
 *{{box-sizing:border-box}}
 ...
 .photorow button{{background:#fff;border:1px solid var(--line);border-radius:8px;
   padding:4px 9px;font-size:13px;cursor:pointer;color:var(--green)}}
 .photorow .pcenter{{background:var(--green);color:#fff;border:none}}
 ...
 .dragbar{{display:flex;align-items:center;justify-content:center;gap:6px;
   font-size:12px;color:var(--muted);margin:0 0 10px;flex-wrap:wrap}}
 .dragbar .dmbtn{{background:#fff;border:1px solid var(--line);border-radius:14px;
   padding:4px 12px;font-size:12.5px;cursor:pointer;color:var(--green)}}
   ...
   <div class="mbody">
     ...
     <div class="mright">
       ...
       <div class="perso">
         ...
         <div class="note">Use the <b>Move: Text / Photo</b> toggle under the preview
           to drag the wording or the photo (one at a time). Resize &amp; rotate the
           text above; fine-tune the photo fit below. Nothing is
         ...
         <div class="uploadbox">
           ...
           <div id="mphotoctl" style="display:none">
             ...
             <div class="photorow">
               ...
               <button type="button" onclick="nudgePhoto(-0.05,0)">&larr;</button>
               <button type="button" onclick="nudgePhoto(0.05,0)">&rarr;</button>
               <button type="button" onclick="nudgePhoto(0,-0.05)">&uarr;</button>
               <button type="button" onclick="nudgePhoto(0,0.05)">&darr;</button>
...
<script>
 ...
 function acceptProof(){{
   ...
   const done=function(emailed){{
     ACCEPTED=true; abConvert && abConvert();
