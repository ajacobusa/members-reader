 ...
 *{{box-sizing:border-box}}
 ...
 /* The 'Pick your size & quantity' prompt pulses while it's waiting too. */
 @keyframes promptpulse{{0%,100%{{box-shadow:0 0 0 0 rgba(201,168,76,0)}}
   50%{{box-shadow:0 0 0 6px rgba(201,168,76,.32)}}}}
 .sizeprompt.attn{{animation:promptpulse 1s ease-in-out infinite}}
 @media (prefers-reduced-motion:reduce){{
   .orow select.attn{{animation:none;border-color:var(--green);
     box-shadow:0 0 0 4px rgba(201,168,76,.32)}}
   .sizeprompt.attn{{animation:none;box-shadow:0 0 0 4px rgba(201,168,76,.30)}}}}
