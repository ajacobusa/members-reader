...
def build_shop_home(password: str = "Jesus", numbers=None, kit_dir=None,
    ...
    try:
        ...
        # Per-mug wrap-ability (#mugwrap): single-panel mugs (handle breaks the wrap:
        # colour-interior / accent / travel) print ONE panel, so the editor must NOT
        # sell them the full-360 "Wraparound" story or spin a full-wrap proof - the
        # buyer would approve a wrap that prints as one panel. Keyed by product_id.
        mug_wraps_json = json.dumps({_p.product_id: bool(_p.wraps) for _p in _MC})
 ...
 *{{box-sizing:border-box}}
 ...
 /* Collapsible control sections: a tap-to-expand header keeps every panel present
    but compact, so nothing is buried below a long panel (#169/#170). The `open`
    state is user-controlled and independent of the JS that shows/hides a panel
    per product type (which only toggles display:none/block). */
 .mcsec>summary{{cursor:pointer;list-style:none;font-size:14px;font-weight:700;
   color:var(--green);display:flex;align-items:center;gap:8px;user-select:none;
   text-align:left}}
 .mcsec>summary::-webkit-details-marker{{display:none}}
 ...
 /* Trust badges sit ABOVE the preview, never ON it: overlaid on the customer's
    own photo (wall art fills the whole frame) they were unreadable and covered
    the picture (owner report 2026-07-19). */
 .pdpbadges{{display:flex;gap:6px;flex-wrap:wrap;margin:0 0 6px;line-height:1.2}}
   ...
   <div class="mbody">
     <div class="mleft" id="mleftcol">
       ...
       <details class="dragbar mcsec" id="mframebar" style="display:none" open>
         ...
         <div class="dbhint" style="text-align:left;margin-top:0">Drag the dashed box to move it, or
       ...
       <details class="dragbar mcsec">
         <summary>&#8596;&#65039; Reposition the wording or photo</summary>
         ...
         <div class="dbhint">Drag any word or the photo on the preview to move it &middot; drag a corner to resize &middot; <b>Reset</b> restores the template.</div>
           ...
           <details id="mphotoctl" class="mcsec" style="display:none" open>
             <summary>🖼️ Resize &amp; place your photo</summary>
             <div class="photorow">
               <span class="plbl">Size</span>
               <span class="zico" aria-hidden="true">−</span>
       ...
       <details class="dragbar mcsec" id="mlayoutbar" style="display:none">
         <summary>&#127912; Pick a layout</summary>
         <div class="dbhint" style="text-align:left;margin-top:0">We arrange your logo &amp; words professionally &mdash; type your words in <b>Step 1</b>, then tweak anything.</div>
...
<script>
 ...
 const MUG_WRAPS = {mug_wraps_json};      // product_id -> prints a full wrap (#mugwrap)
