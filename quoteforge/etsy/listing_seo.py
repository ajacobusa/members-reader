...
def _build_description(listing, niche: str) -> str:
    ...
    return (
        ...
        f"HOW IT WORKS\n"
        f"1. Personalize it live - add the name, the occasion, and your own words or photo.\n"
        f"2. Approve your free proof on screen - exactly what prints, before you buy.\n"
        f"3. Printed on premium stock and shipped directly to you with tracking.\n\n"
        f"WHAT'S INCLUDED\n"
        f"- A one-of-a-kind, personalized design written for your {recipient.lower()}\n"
        f"- Free proof you approve on screen\n"
