...
def _parse_contact(design_json: str) -> dict:
    ...
    try:
        return (json.loads(design_json or "{}") or {}).get("contact") or {}
    except Exception:  # noqa: BLE001
        return {}
...
def _intake_order(email: str, design_id: str, contact: dict) -> str:
    ...
    returns the order id, or '' when shipping details are missing."""
...
def confirm_design(email: str, summary: str = "", design_json: str = "",
    ...
    order_id = _intake_order(email, design_id, contact)
